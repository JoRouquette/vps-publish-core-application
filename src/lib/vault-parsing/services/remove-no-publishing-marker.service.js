...
exports.RemoveNoPublishingMarkerService = void 0;
/**
 ...
 */
class RemoveNoPublishingMarkerService {
    constructor(logger) {
        this.logger = logger;
        this.markerPattern = /^\s*\^no-publishing\s*$/i;
        this.headerPattern = /^ {0,3}(#{1,6})\s+(.+)$/;
        this.horizontalRulePattern = /^ {0,3}(?:[-*_]\s*){3,}$/;
        this.setextUnderlinePattern = /^ {0,3}(?:=+\s*|-+\s*)$/;
        this.fencedCodePattern = /^ {0,3}(`{3,}|~{3,})/;
        this.indentedCodePattern = /^(?: {4,}|\t+)/;
    }
    process(notes) {
     ...
     */
    findDelimiter(lines, contexts, fromIndex) {
    ...
    getSetextHeadingStart(lines, contexts, underlineIndex) {
...
exports.RemoveNoPublishingMarkerService = RemoveNoPublishingMarkerService;
