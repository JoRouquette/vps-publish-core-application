...
exports.EnsureTitleHeaderService = void 0;
/**
 ...
 */
class EnsureTitleHeaderService {
    constructor(logger) {
        this.logger = logger;
    }
    process(notes) {
     ...
     */
    insertTitleHeader(content, title, level) {
...
exports.EnsureTitleHeaderService = EnsureTitleHeaderService;
