...
exports.DetectLeafletBlocksService = void 0;
/**
 ...
 */
class DetectLeafletBlocksService {
    constructor(logger) {
     ...
     */
    parseLeafletProperty(key, value, block, markers, imageOverlays) {
     ...
     */
    parseImageOverlays(value, overlays) {
     ...
     */
    parseTileServer(value) {
        return {
            url: value.trim(),
        };
    }
}
exports.DetectLeafletBlocksService = DetectLeafletBlocksService;
